...
class LoginPage extends StatelessWidget {
  ...
  MaskTextInputFormatter mobileMasking = MaskTextInputFormatter(
    mask: '###-####-###',
  );
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            PrimaryButton(
              onPressed: () {
                Navigator.push(context, PageTransition(child: OtpPage(), type: PageTransitionType.rightToLeft));
              },
              title: 'Login',
            ),
            const SizedBox(
